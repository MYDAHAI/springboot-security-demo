package com.ay.system.generator;
...
public class CodeGeneration {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig
                .Builder("jdbc:mysql://mysql-dev.rwlb.rds.aliyuncs.com:2593/guiyan_system_manage?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai","guiyanuser","uD&HVPEpijFqRoDCiJVf")
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("com.ay.system.test")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
                .controller("controller")//控制层包名
                .mapper("dao")//mapper层包名
                .xml("mapper.xml")//数据访问层xml包名
                .service("service")//service层包名
                .serviceImpl("service.impl")//service实现类包名
                .other("diy")//输出自定义文件时的包名
